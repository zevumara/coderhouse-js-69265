...
// Cargamos los items desde un archivo .json usando fetch
async function cargar_items_desde_json() {
  const resultado = await fetch("items.json");
...
// Versión función flecha asincrónica sintaxis
// const cargar_items_desde_json = async () => {};
